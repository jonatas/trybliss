...
//  Symbols.find().forEach(function(e){Symbols.remove(e._id);});
  if (Symbols.find().count() == 0) {
     symbols = [
       ...
       "hiccup(s)_(1)",
       "hiccup(s)_(2)",
       "hidden_treaxual_(female),lesbian",
       ...
       "key_guard",
       "keyboard",
       "keyboard_(coon_(spoken)",
       "invitation_(written)",
       "invoice",
       "iron,smoothing_irck-(to)",
       ...
       "knit-(to)",
       "knock,tap-(to)",
       "knock,tap_(sound)ump_rope,skipping_rope",
       "juridical",
       "jury",
       "just,fair",
       "justicons)",
       ...
       "kiss-(to)",
       "kiss",
       "kitchen.pomat,launderette,laundry",
       "laundry_(workplace)",
       "lava,magma",
       "law,The_Law",
       "law-(a)",
       ...
       "mind_sports",
       "mine",
       "minister,pastor,preacheg",
       "meditate-(to)",
       "meet,encounter,see-(to)",
       "meeting,assembly,confete",
       "minutes",
       "miracle",
       "mirror",
       ...
       "mustard_sauce",
       "muzzle",
       "my,mine-(femisition)-(to)",
       "move_bowels,defecate,stool,shit,ca-ca-(to)",
       "movement,motion_(1)",
       "movement,motion_(2)",
       "movie,film",
       "movie_theatre,cme,label,term,title",
       "naming_ceremony",
       ...
       "paddle,oar",
       "paddle_(two_blades)",
       "paddle_boat,pedal_boat,water_g",
       "orienteer_(sport)-(to)",
       "orienteering_(sport)",
       "orthopaedist.pngfering",
       ...
       "prone_board,scooter-edness",
       "prepapng",
       "potato_chip(s),chip(s),crisp(s).pnng",
       "public_(not_private)",
       ...
       "sell-(to)",
       "semen",
       "semi-de,body_of_learning",
       "science",
       "science_centre",
       "scientist,academisentence,clause,phrase",
       "sentence,condemn-(to)",
       "sequin(s),spangle(s)",
       "service_(help)",
       "service_(work)",
       ...
       "self-harm",
       "self-harming",
       "selfish,self-centred,self-centeredre-(to)",
       "shark",
       "sharp_(knife)",
       ...
       "side_(enclosure)",
       "sidecar_(motorcycle)",
       "si_soap,shaving_cream",
       "she,her,herself",
       "sheep",
       "sheet(s),bedclotement",
       "sign,signal",
       "sign-(to)",
       "sign_(OLD)",
       "sign_language",
       ...
       "sliced",
       "slide",
       "slip,petticoat,half-s,like,alike",
       "similar_looking,looks_similar",
       "similar_sound,soundsg",
       "small_intestine",
       "small_pancake,blini",
       ...
       "soon",
       "soprano",
       "sorpray_bottle,vaporizer,spray_can",
       "spread,paste",
       ...
       "sciologist",
       "sociology",
       "soda_pop,pop,soft_drink.pnin-(to)",
       "steak",
       "steal-(to)",
       "steam-(to)",
       "steam",
       ...
       "subtion,entire.pngretamp",
       "stand-(to)",
       "stand-in,substitute,alternate.ccess",
       ...
       "stress-(to)",
       "stress",
       "stressed.pisplay,symbol_board,symbol_chart",
       "synagogue",
       "synchronized_diving",
       ...
       "table_mat,placemat",
       "table_sports",
       "table_tennis,ping-pongstand-in,substrsical_hole",
       "g",
       "submerged_rock",
       "substance",
       "subtract,remove,take_away-(to)",
       ...
       "theatre",
       "theft",
       "their,theirs-(feminine_plural).pngports",
       "tablrey_store",
       "sw_lift,lift",
       "tail_wing_(airplane)",
       "ir,theirs-(persons)",
  ...
  Meteor.publish("symbols", function(){ return Symbols.find() });
});
