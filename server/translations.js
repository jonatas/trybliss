...
var translations = [
   ...
   {lang: 'br', base_str: 'Full Screen', new_str: 'Tela cheia'},
   ...
   {lang: 'br', base_str: 'New File', new_str: 'Novo arquivo'},
   {lang: 'br', base_str: 'Rename', new_str: 'Renomear'},
   ...
   {lang: 'se', base_str: 'Full Screen', new_str: 'helskärm'},
   ...
   {lang: 'de', base_str: 'Full Screen', new_str: 'Vollbild'},
